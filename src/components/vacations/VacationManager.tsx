...
export const VacationManager = ({ profile }: VacationManagerProps) => {
  ...
  // Formulario (Sin campo motivo, por defecto siempre será vacación)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Enviamos siempre 'vacation' como motivo
  ...
  const getStatusBadge = (s: string) => {
    switch(s) {
        case 'approved': return <Badge className="bg-emerald-500 hover:bg-emerald-600">Aprobado</Badge>;
  ...
  // --- 🔥 CAMBIO AQUÍ: CLASE PARA COLOR BLANCO 🔥 ---
  // Usamos 'invert' para cambiar el icono negro por defecto a blanco
      ...
      <Card>
        ...
        <CardContent>
            <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-4 items-end">
                ...
                {/* Campo motivo eliminado: Ahora es solo comentario */}
