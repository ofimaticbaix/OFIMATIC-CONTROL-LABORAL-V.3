...
export const AdminPanel = () => {
  ...
  if (loading) return (
    <div className="h-[60vh] flex flex-col items-center justify-center gap-4">
      ...
      <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Verificando permisos de administración...</p>
    </div>
  );
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between px-2">
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-500 font-medium uppercase tracking-[0.1em]">Gestión de Plantilla Ofimatic</p>
        </div>
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border border-slate-200/60 dark:border-slate-800 shadow-2xl min-h-[450px]">
        ...
        {entries.length === 0 ? (
          <div className="p-24 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div className="space-y-1">
              <p className="font-bold text-slate-900 dark:text-white uppercase text-xs tracking-widest">Sin datos disponibles</p>
              <p className="text-[10px] text-slate-500 uppercase max-w-[250px] mx-auto leading-relaxed">
                Ejecuta el script SQL en Supabase para habilitar la visualización administrativa.
              </p>
            </div>
          </div>
        ) : (
            ...
            <Table>
              <TableHeader className="bg-slate-50/50 dark:bg-black/10">
                <TableRow className="hover:bg-transparent border-b border-slate-100 dark:border-slate-800">
                  ...
                  <TableHead className="py-5 text-[10px] font-bold uppercase tracking-widest text-slate-500 text-center">Horario</TableHead>
                  <TableHead className="py-5 text-right text-[10px] font-bold uppercase tracking-widest text-slate-500">Total</TableHead>
                  <TableHead className="py-5 pr-8 text-center text-[10px] font-bold uppercase tracking-widest text-slate-500">Gestión</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
